...
import "highlight.js/styles/an-old-hope.css"; // import your preferred style
...
export class CodeHighlight extends Component {
    ...
    componentDidMount() {
        ...
        if (language && !registeredLanguages[language]) {
            try {
                ...
                console.error(e);
                throw Error(
                    `Cannot register and higlight language ${language}`
                );
    ...
    render() {
        ...
        return (
            <pre>
                <code id="code" ref={this.codeNode} className={language}>
                    {children}
                </code>
            </pre>
        );
